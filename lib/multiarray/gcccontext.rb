...
{
  rb_require("#{DIRNAME}/#{@lib_name}_ext.rb");
...
# This file is generated automatically. Do not edit this file.
module Hornetseye
  #MultiArray(UBYTE,1).class_eval do
  #  def -@
  #    retval = self.class.new *shape
  #    GCCCache._Store0Lambda0Variable60INDEX0Variable20INT1112Lookup0Variable0050UBYTE112Variable60INDEX0Variable20INT1112Variable10INT1112490Lambda0Variable60INDEX0Variable50INT1112Lookup0Variable3050UBYTE112Variable60INDEX0Variable50INT1112Variable40INT11111 *(retval.values + values)
  #    retval
  #  end
  #end
end
EOS
      ...
      File.open "#{DIRNAME}/#{@lib_name}_ext.rb", 'w', 0600 do |f|
        f << rb_template
      end
